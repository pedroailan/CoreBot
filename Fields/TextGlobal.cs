...
namespace CoreBot.Fields
{
    ...
    {
        public static string Ajuda { get; set; } = "Posso ajudar em algo mais? " + Emojis.Sorriso;
        public static string Prosseguir { get; set; } = "Deseja prosseguir? \r\n1. Sim \n2. Não";
        public static string Choice { get; set; } = "\r\n1. Sim \n2. Não";
        public static string Desculpe { get; set; } = "Desculpe, não conseguir entender. " + Emojis.Carro + " \r\n";
