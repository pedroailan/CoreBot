...
namespace CoreBot.Models.Generate
{
    ...
    public class GeneratePdfCompensacao
    {
        ...
        public static void WriteDocument(Document doc, PdfWriter writer, FieldsGenerate data)
        {
            ...
            doc.Add(parag);
            doc.Add(tableVia(writer, FonteVia, page, imageBanese, Subtitulo, data));
            doc.Close();
        }
        ...
        public static PdfPTable tableObservacoes(Font FontePadrao, Font Subtitulo, FieldsGenerate data)
        {
            ...
            if (data.mensagem1 != "")
            {
                PdfPCell cellDisc11 = new PdfPCell(new Phrase(data.mensagem1, FontePadrao));
                cellDisc11.Border = 0;
                tableObs.AddCell(cellDisc11);
            }
            if (data.mensagem2 != "")
            {
                PdfPCell cellDisc2 = new PdfPCell(new Phrase(data.mensagem2, FontePadrao));
                cellDisc2.Border = 0;
                tableObs.AddCell(cellDisc2);
            }
            if (data.mensagem3 != "")
            {
                PdfPCell cellDisc3 = new PdfPCell(new Phrase(data.mensagem3, FontePadrao));
                cellDisc3.Border = 0;
                tableObs.AddCell(cellDisc3);
            }
            if (data.mensagem4 != "")
            {
                PdfPCell cellDisc4 = new PdfPCell(new Phrase(data.mensagem4, FontePadrao));
                cellDisc4.Border = 0;
                tableObs.AddCell(cellDisc4);
            }
            if (data.mensagem5 != "")
            {
                PdfPCell cellDisc5 = new PdfPCell(new Phrase(data.mensagem5, FontePadrao));
                cellDisc5.Border = 0;
        ...
        public static PdfPTable tableVia(PdfWriter writer, Font FontePadrao, Rectangle page, iTextSharp.text.Image image, Font Subtitulo, FieldsGenerate data)
        {
            /// CABEÇALHO
            ...
            PdfPCell viaCellNum= new PdfPCell(new Phrase(data.codBarras, Subtitulo));
            ...
            PdfPCell cell16 = new PdfPCell(new Phrase("Instruções" +
                                                        ...
                                                        data.mensagem1 + " " + data.mensagem2, FontePadrao));
            ...
            PdfPCell cell21 = new PdfPCell(new Phrase("(=) Valor cobrado: R$ " + data.valorTotal, FontePadrao));
            ...
            PdfPCell cell24 = new PdfPCell(new Phrase("CPF/CNPJ: \n" + data.cpf, FontePadrao));
            cell24.HorizontalAlignment = 0;
            cell24.Colspan = 3;
            tableVia.AddCell(cell24);

            //LINHA 7
            PdfPCell cell25 = new PdfPCell(new Phrase("Sacador/Avalista: " + data.sacador, FontePadrao));
            ...
            PdfPCell viaCell6 = new PdfPCell(new Phrase(data.codBarras, FontePadrao));
